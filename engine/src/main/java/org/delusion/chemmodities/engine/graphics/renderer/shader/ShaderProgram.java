package org.delusion.chemmodities.engine.graphics.renderer.shader;
...
public class ShaderProgram {
    ...
    public int readShaderFile(String path) {
    ...
    public ShaderProgram(String... shaderPaths) {
        ...
        System.out.println("Link Status: " + (link_status == GL_TRUE));
